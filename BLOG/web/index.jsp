  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" id="btnGiris" class="btn btn-default" data-dismiss="modal">TAMAM</button>
      </div>
    </div>
    <script>
     $("#btnGiris").click(function()
     {
            ...
            $.post("adminLogin.jsp", { "un" : un, "pw" : pw }, function(data,success)
            {
               var gelen = $.trim(data);
               if (gelen == "ERROR")
