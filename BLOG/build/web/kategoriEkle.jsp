  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-warning">
        ...
        <div class="panel-content" style="padding:12px;">
            <form id="katEkle" action="yeniKat.jsp" method="post">
                <div class="form-group">
                    <label><b>Kategori Adı : </b></label>
                    <input type="text" name="kAd" id="kAd" class="form-control" />
                </div>
                
                <div class="form-group text-right">
                    <input type="button" id="katEkle" class="btn btn-default" value="Kategori Ekle" />
                </div>
            </form>
    ...
    <div class="panel panel-warning">
        ...
        <div class="panel-content" style="padding:12px;">
            <table id="kategoriListesi" width="100%" class="table table-striped table-bordered table-hovered">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>AD</th>
