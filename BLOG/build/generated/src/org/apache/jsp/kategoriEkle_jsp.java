...
public final class kategoriEkle_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if (o == null)
  {
      ...
      out.write("          <ul class=\"dropdown-menu\">\r\n");
      out.write("            <li><a href=\"kategoriEkle.jsp\">Yeni Kategori Ekle</a></li>\r\n");
      out.write("            <li role=\"separator\" class=\"divider\"></li>\r\n");
      ...
      out.write("            <b>KATEGORI EKLE</b>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"panel-content\" style=\"padding:12px;\">\r\n");
      out.write("            <form id=\"katEkle\" action=\"yeniKat.jsp\" method=\"post\">\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <label><b>Kategori Adı : </b></label>\r\n");
      out.write("                    <input type=\"text\" name=\"kAd\" id=\"kAd\" class=\"form-control\" />\r\n");
      out.write("                </div>\r\n");
      out.write("                \r\n");
      out.write("                <div class=\"form-group text-right\">\r\n");
      out.write("                    <input type=\"button\" id=\"katEkle\" class=\"btn btn-default\" value=\"Kategori Ekle\" />\r\n");
      out.write("                </div>\r\n");
      out.write("            </form>\r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      ...
      out.write("    <div class=\"panel panel-warning\">\r\n");
      out.write("        <div class=\"panel-heading\">\r\n");
      out.write("            <b>KATEGORI LISTESI</b>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div class=\"panel-content\" style=\"padding:12px;\">\r\n");
      out.write("            <table id=\"kategoriListesi\" width=\"100%\" class=\"table table-striped table-bordered table-hovered\">\r\n");
      out.write("                <thead>\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <th>ID</th>\r\n");
      out.write("                        <th>AD</th>\r\n");
      ...
      out.write("                    ");
                      ...
                      ResultSet yorumRS = db.qWR("select * from kategoriler");
                      while (yorumRS.next())
                      {
                          String id = yorumRS.getString("id");
                          out.println("<tr>");
                          out.println("<td>"+yorumRS.getString("id")+"</td>");
                          out.println("<td>"+yorumRS.getString("ad")+"</td>");
                          out.println("<td><a href='katSil.jsp?id="+id+"'><i class='fa fa-trash-o fa-2x'></i></a>");
                          out.println("</tr>");
                      }
